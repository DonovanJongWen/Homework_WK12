    ...
    inquirer
        .prompt({
            ...
            choices:
                [
                    "View Employee List",
                    "View Employee list sorted by Department",
                    "View Manager assigned to Employee",
                    "Add Employee",
                    "Remove Employee",
                    "Update Employee Role",
                    "Update Employee Manager Details",
                    "View All Role",
                    "Add Role",
                    "Remove Role",
        ...
        .then(function (answer) {
            switch (answer.menuMain) {
                case "View Employee List":
                    ...
                    break;
                case "View Employee list sorted by Department":
                    selectDeptView();
                    break;
                case "View Manager assigned to Employee":
                    selectManagerView();
                    break;
                case "Add Employee":
                    addEmployee();
                ...
                case "Update Employee Role":
                    updateEmployeeRole();
                    break;
                case "Update Employee Manager Details":
